      ...
      <footer className='fixed bottom-0 left-0 right-0 z-50 w-full bg-sub shadow-[0px_0px_8px_rgba(0,0,0,0.1)]'>
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto mt-2 max-w-2xl py-6 text-end lg:mx-0 lg:max-w-none'>
            <button className='btn-close mb-2 w-full py-2 font-bold text-sub transition-colors sm:mb-0 sm:w-28' type='button' onClick={() => navigate('/')}>
              나가기
            </button>
            <button type='submit' className='btn-success w-full py-2 text-sub transition-colors sm:mb-0 sm:ml-2 sm:w-28'>
